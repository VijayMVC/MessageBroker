...
{
    [EventSource(Name = "Khooversoft.MessageBroker.QueueDbRepository")]
    public sealed class QueueDbEventSource : EventSource, IEventLog
    {
        /// <summary>
        /// Singleton for ETW logging
        /// </summary>
        public static QueueDbEventSource Log { get; } = new QueueDbEventSource();
